                          ...
                          Padding(
                            ...
                            child: MasonryGridView.builder(
                              ...
                              itemBuilder: (context, index) => BlogBox(
                                title: blog_story[index]['title'],
                                name: blog_story[index]['user']['fullname'],
                                category: blog_story[index]['category'],
                                like: blog_story[index]['save'] ?? "0",
                                image: NetworkImage(
                                  blog_story[index]['image_link'],
                                ),
                                onPressed: () {
                                  Navigator.pushNamed(
                                    context,
                                    tuachuayDekhorPageRoute['blog']!,
                                    arguments: blog_story[index]['id_post'],
                                  );
                                },
                              ),
                            ),
